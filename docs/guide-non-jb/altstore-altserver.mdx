...
:::info
È consigliato seguire la guida per [Installare SideStore](sidestore) in quanto possiede le stesse funzionalità di AltStore eliminando la necessità di un computer ogni volta che si intende installare/refreshare un'app.
:::
